...
Interactive mode for when the candidate is filling out an application form in Chrome. Reads what's on the screen, loads the previous context of the offer, and generates personalized answers for each question in the form.
...
4. If there's Section G → load previous draft answers as a base.
